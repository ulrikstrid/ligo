...
and block_closing = Block of rbrace | End of kwd_end

and statements = (statement, semi) nsepseq

and statement = Instr of instruction | Data of data_decl | Attr of attr_decl
...
and closing = End of kwd_end | RBracket of rbracket
...
and logic_expr = BoolExpr of bool_expr | CompExpr of comp_expr
...
and string_expr = Cat of cat bin_op reg | String of Lexer.lexeme reg
