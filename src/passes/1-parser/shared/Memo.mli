...
val make_loc : Region.t -> (location, invalid_loc) Stdlib.result
...
type phase = Lexer | Parser of window | Scoping
...
val make_error :
  location:location -> message:message -> hint:string -> help:string -> error
