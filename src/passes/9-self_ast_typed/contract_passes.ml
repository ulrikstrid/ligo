...
module Errors = struct
  let bad_self_type _expected _got _loc = simple_error "TODO"
  ...
  let bad_format_entrypoint_ann _ep _loc = simple_error "TODO"
  ...
  let entrypoint_annotation_not_literal _loc = simple_error "TODO"
  ...
  let unmatched_entrypoint _loc = simple_error "TODO"
...
let self_typing : contract_pass_data -> expression -> (bool * contract_pass_data * expression , [> error]) result = fun dat e ->
