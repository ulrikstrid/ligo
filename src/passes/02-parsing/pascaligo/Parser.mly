...
%on_error_reduce module_path_e
%on_error_reduce module_path_t
...
open_module_decl:
  "module" module_name "is" "{" declarations "}" {
    let enclosing = Brace ($4,$6) in
...
| "block" "{" sep_or_term_list(statement,";") "}" {
     ...
     and enclosing : block_enclosing = Block ($1,$2,$4) in
