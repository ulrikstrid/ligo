...
val type_program     : bool -> environment -> I.program -> (environment * O.program * typer_error O'.typer_state, typer_error) result
val type_declaration : bool -> environment -> typer_error O'.typer_state -> I.declaration -> (environment * typer_error O'.typer_state * O.declaration , typer_error) result
val evaluate_type : environment -> I.type_expression -> (O.type_expression , typer_error) result
val type_expression : bool -> environment -> typer_error O'.typer_state -> ?tv_opt:O.type_expression -> I.expression -> (O.expression * typer_error O'.typer_state , typer_error) result
