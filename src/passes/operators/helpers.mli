module Typer : sig
  ...
  module Errors : sig
    ...
    val error_uncomparable_types :
      type_expression -> type_expression -> unit -> error
  end

  type type_result = type_expression

  type typer =
    type_expression list -> type_expression option -> type_result result
  ...
  *)
  ...
  val assert_eq_1 :
    ?msg:string -> type_expression -> type_expression -> unit result
