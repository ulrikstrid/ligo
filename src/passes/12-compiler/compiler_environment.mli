...
val get : environment -> expression_variable -> (michelson , [> error]) result

val pack_closure : environment -> selector -> (michelson , [> error]) result
val unpack_closure : environment -> (michelson , [> error]) result
