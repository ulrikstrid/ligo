...
let self_cst_reasonligo_tracer (e: Self_cst.Jsligo.Errors.self_cst_reasonligo_error) : all = `Main_self_cst_reasonligo e
let self_cst_jsligo_tracer (e:Self_cst.Reasonligo.Errors.self_cst_jsligo_error) : all = `Main_self_cst_jsligo e
