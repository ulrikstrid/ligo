...
val result_pp_hr :
  ...
  Format.formatter ->
  'a Simple_utils.Trace.result ->
  unit

val string_result_pp_hr :
  Format.formatter -> string Simple_utils.Trace.result -> unit
...
val formatted_string_result_pp :
  display_format ->
  Format.formatter ->
  string Simple_utils.Trace.result ->
  unit
...
val michelson_pp :
  michelson_format ->
  Format.formatter ->
  Tezos_utils.Michelson.michelson ->
  unit
