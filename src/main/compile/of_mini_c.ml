...
let compile_contract : expression -> (Compiler.compiled_expression , [> error]) result = fun e ->
...
let compile_expression : expression -> (Compiler.compiled_expression, [> error]) result = fun e ->
