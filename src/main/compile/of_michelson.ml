...
*)
  ...
  let bad_parameter _c = simple_error "TODO"
  let bad_storage _c = simple_error "TODO"
  let bad_contract _c = simple_error "TODO"
  let ran_out_of_gas = simple_error "TODO"
  let unknown = simple_error "TODO"
  (* let bad_parameter c () =
    let message () =
...
let build_contract : ?disable_typecheck:bool -> Compiler.compiled_expression -> (Michelson.michelson , [> error]) result =
...
let assert_equal_contract_type : check_type -> Compiler.compiled_expression -> Compiler.compiled_expression -> (unit , [> error]) result =
  fun c compiled_prg compiled_param ->
    ...
    let%bind _ = 
      ...
      Trace.trace_tzresult (fun _err -> simple_error "TODO") @@
