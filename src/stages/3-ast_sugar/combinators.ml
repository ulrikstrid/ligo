...
let e_let_in_ez ?loc var ?ascr ?var_attributes mut attributes rhs let_result =
  let var_attributes = Option.unopt ~default:Stage_common.Helpers.default_binder_attributes var_attributes in
  e_let_in ?loc {var;ascr;attributes=var_attributes} mut attributes rhs let_result
