...
let list_empty_name = "list_empty"
...
let map_find_opt_name = "map_find_opt"
let create_contract_name = "create_contract"
...
let ev_list_empty : expression_variable = lwrap @@ Var.of_name list_empty_name
...
let ev_map_find_opt : expression_variable = lwrap @@ Var.of_name map_find_opt_name
...
let ev_map_add : expression_variable = lwrap @@ Var.of_name map_add_name
let ev_set_add : expression_variable = lwrap @@ Var.of_name set_add_name
let ev_concat : expression_variable = lwrap @@ Var.of_name concat_name
let ev_cons : expression_variable = lwrap @@ Var.of_name cons_name
let ev_update : expression_variable = lwrap @@ Var.of_name update_name
let ev_create_contract : expression_variable = lwrap @@ Var.of_name create_contract_name