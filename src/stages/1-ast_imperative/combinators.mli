...
val t_operator :
  type_operator -> type_expression list -> type_expression result
...
val e_map_add :
  ?loc:Location.t -> expression -> expression -> expression -> expression
...
val e_accessor_list :
  ?loc:Location.t -> expression -> string list -> expression
...
val e_annotation :
  ?loc:Location.t -> expression -> type_expression -> expression

val e_application : ?loc:Location.t -> expression -> expression -> expression

val e_binop :
  ?loc:Location.t -> constant' -> expression -> expression -> expression
...
val ez_match_variant :
  ((string * string) * 'a) list -> ('a, unit) matching_content

val e_matching_variant :
  ?loc:Location.t ->
  expression ->
  ((string * string) * expression) list ->
  expression

val make_option_typed :
  ?loc:Location.t -> expression -> type_expression option -> expression

val e_typed_none : ?loc:Location.t -> type_expression -> expression

val e_typed_list :
  ?loc:Location.t -> expression list -> type_expression -> expression

val e_typed_list_literal :
  ?loc:Location.t -> expression list -> type_expression -> expression
...
val e_update :
  ?loc:Location.t -> expression -> string -> expression -> expression
...
val e_ez_assign :
  ?loc:Location.t -> string -> string list -> expression -> expression
...
val e_for_each :
  ?loc:Location.t ->
  expression_variable * expression_variable option ->
  expression ->
  collect_type ->
  expression ->
  expression
