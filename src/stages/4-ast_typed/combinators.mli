...
val t_contract :
  type_expression -> ?s:S.type_expression -> unit -> type_expression
...
val t_variable :
  type_variable -> ?s:S.type_expression -> unit -> type_expression

val t_record :
  type_expression label_map -> ?s:S.type_expression -> unit -> type_expression

val make_t_ez_record : (string * type_expression) list -> type_expression

val ez_t_record :
  (label * type_expression) list ->
  ?s:S.type_expression ->
  unit ->
  type_expression
...
val t_sum :
  type_expression constructor_map ->
  ?s:S.type_expression ->
  unit ->
  type_expression
...
val get_lambda_with_type :
  expression -> (lambda * (type_expression * type_expression)) result
...
val e_a_variable :
  expression_variable -> type_expression -> full_environment -> expression
