...
and declaration =
  ...
  | Declaration_constant of
      (expression_variable * expression * inline * full_environment)
...
and environment_element_definition_declaration =
  {expr: expression; free_variables: free_variables}
...
and environment_binding =
  {expr_var: expression_variable; env_elt: environment_element}

and type_environment = type_environment_binding list

and type_environment_binding =
  {type_variable: type_variable; type_: type_expression}

(* SUBST ??? *)
and small_environment =
  {expression_environment: environment; type_environment: type_environment}
...
and named_type_content = {type_name: type_variable; type_value: type_expression}
