...
let e_lambda_ez   ?loc ?sugar var ?ascr ?var_attributes output_type result         =
  let var_attributes = Option.unopt ~default:Stage_common.Helpers.default_binder_attributes var_attributes in
  e_lambda ?loc ?sugar {var;ascr;attributes=var_attributes} output_type result
...
let e_let_in_ez   ?loc ?sugar var ?ascr ?var_attributes inline rhs let_result =
  let var_attributes = Option.unopt ~default:Stage_common.Helpers.default_binder_attributes var_attributes in
  e_let_in ?loc ?sugar {var;ascr;attributes=var_attributes} rhs let_result inline
