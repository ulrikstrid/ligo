...
val translate_annotated_expression : AST.annotated_expression -> expression result
val translate_lambda_deep : Mini_c.Environment.t -> AST.lambda -> Mini_c.expression result
val translate_lambda : Environment.t -> AST.lambda -> expression result
val translate_declaration : environment -> AST.declaration -> toplevel_statement result
*)

val translate_program : AST.program -> program result
val translate_main : AST.lambda -> Location.t -> anon_function result
...
val translate_entry : AST.program -> string -> anon_function result
