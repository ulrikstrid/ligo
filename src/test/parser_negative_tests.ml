...
let pascaligo_sdata = {
  ...
  parser  = (trace parser_tracer ) <@ (Ligo_parser.Pascaligo.parse_expression   []) }
let cameligo_sdata = {
  ...
  parser  = (trace parser_tracer ) <@ (Ligo_parser.Cameligo.parse_expression   []) }
let reasonligo_sdata = {
  ...
  parser  = (trace parser_tracer ) <@ (Ligo_parser.Reasonligo.parse_expression   []) }
