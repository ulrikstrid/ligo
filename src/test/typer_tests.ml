...
module TestExpressions = struct
  ...
  let recursive () : (unit,_) result =
    ...
    let lambda = I.{binder={var;ascr=Some(t_nat ());attributes=Stage_common.Helpers.default_binder_attributes};
  ...
  let matching () : (unit, _) result =
    ...
    in
    let binder_wild : type_expression binder = {var=Location.wrap (Var.of_name "_");ascr=None;attributes=Stage_common.Helpers.default_binder_attributes} in
    let binder_x : type_expression binder = {var=Location.wrap (Var.of_name "x");ascr=None;attributes=Stage_common.Helpers.default_binder_attributes} in
    let binder_y : type_expression binder = {var=Location.wrap (Var.of_name "y");ascr=None;attributes=Stage_common.Helpers.default_binder_attributes} in
    test_expression
      ~env:(E.add_type (Var.of_name "test_t") variant_foo_bar E.empty)
