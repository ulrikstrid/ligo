...
let%expect_test _ =
  ...
  [%expect {|
    Warning: unused variable "main" in file "../../test/contracts/michelson_pair_tree.jsligo", line 8, characters 4-8.
    Warning: unused variable "action" in file "../../test/contracts/michelson_pair_tree.jsligo", line 8, characters 13-19.
    Warning: unused variable "store" in file "../../test/contracts/michelson_pair_tree.jsligo", line 8, characters 21-26.
    { parameter unit ;
      storage (pair (int %three) (pair %four (int %one) (nat %two))) ;
