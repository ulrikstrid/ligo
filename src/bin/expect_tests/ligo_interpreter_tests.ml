...
let%expect_test _ =
  ...
  [%expect {|
    in file "../../test/contracts/negative//interpreter_tests/test_failure1.mligo", line 2, characters 2-25
      1 | let test =
...
let%expect_test _ =
  ...
  [%expect {|
    in file "../../test/contracts/negative//interpreter_tests/test_failure2.mligo", line 2, characters 4-16
      1 | let test =
      2 |     assert false
...
let%expect_test _ =
  ...
  [%expect {|
    in file "../../test/contracts/negative//interpreter_tests/test_failure3.mligo", line 2, characters 11-38
      1 | let test =
