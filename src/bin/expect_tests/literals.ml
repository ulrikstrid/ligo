...
let%expect_test _ =
  ...
  [%expect {|
    ligo: Command line parameter EXPRESSION, in file "", line 0, characters 1-32. Badly formatted literal: signature thisisnotasignature {"location":"Command line parameter EXPRESSION, in file \"\", line 0, characters 1-32"}
...
let%expect_test _ =
  ...
  [%expect {|
    ligo: Command line parameter EXPRESSION, in file "", line 0, characters 1-26. Badly formatted literal: key thisisnotapublickey {"location":"Command line parameter EXPRESSION, in file \"\", line 0, characters 1-26"}
